...
type GreetServiceClient interface {
	...
	ShowDetails(ctx context.Context, in *PersonDetailRequest, opts ...grpc.CallOption) (*PersonDetailResponse, error)
	// Server Streaming
...
func (c *greetServiceClient) ShowDetails(ctx context.Context, in *PersonDetailRequest, opts ...grpc.CallOption) (*PersonDetailResponse, error) {
	out := new(PersonDetailResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/ShowDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GreetServiceServer interface {
	...
	ShowDetails(context.Context, *PersonDetailRequest) (*PersonDetailResponse, error)
	// Server Streaming
...
func (UnimplementedGreetServiceServer) ShowDetails(context.Context, *PersonDetailRequest) (*PersonDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ShowDetails not implemented")
}
...
func _GreetService_ShowDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PersonDetailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).ShowDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/ShowDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).ShowDetails(ctx, req.(*PersonDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GreetService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GreetService_ShowDetails_Handler,
		},
		{
